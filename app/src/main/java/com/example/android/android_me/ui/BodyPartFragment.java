...
public class BodyPartFragment extends Fragment {
    ...
    private static final String STATE_IMAGE_LIST = "image_id_list";
    private static final String STATE_LIST_INDEX = "image_list_index";
    // Tag for logging
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        if (savedInstanceState != null) {
            mImageIds = savedInstanceState.getIntegerArrayList(STATE_IMAGE_LIST);
    ...
    public void onSaveInstanceState(Bundle outState) {
        outState.putIntegerArrayList(STATE_IMAGE_LIST, (ArrayList<Integer>)mImageIds);
        outState.putInt(STATE_LIST_INDEX, mListIndex);
